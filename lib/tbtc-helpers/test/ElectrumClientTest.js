...
describe('ElectrumClient', async () => {
  ...
  const clientConfig = new ElectrumClient.Config(
  ...
  before(async () => {
    ...
    client = new ElectrumClient.Client(clientConfig)
  ...
  describe('waitForTransactionToScript', async () => {
    describe('with no callback', async () => {
      it('subscribe for script hash when transaction already exists', async () => {
        const script = '00144b47c798d12edd17dfb4ea98e5447926f664731c'

        result = await client.waitForTransactionToScript(script)
      ...
      it('subscribe for new script and wait for notification', async () => {
        ...
        result = client.waitForTransactionToScript(script1)
    ...
    describe('with a callback', async () => {
      it('subscribe for script hash when transaction already exists', async () => {
        const script = '00144b47c798d12edd17dfb4ea98e5447926f664731c'
        const expectedResult = {
        ...
        result = await client.waitForTransactionToScript(script, callback)
      ...
      it('subscribe for new script and wait for notification', async () => {
        ...
        result = client.waitForTransactionToScript(script1, callback)
