...
const TLogo = ({ width, height }) => {
    return (
        <svg className="tlogo" width={width} height={height} viewBox="0 0 106 106" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <circle cx="53" cy="53" r="49.5" stroke="white" strokeWidth="10"/>
        </svg>
    )
}
